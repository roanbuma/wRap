...
add_theme = theme(
  plot.title = element_text(size = 30, color="#1ed760", face = "bold",hjust = 0.5, margin = margin(b = 60)),
  ...
  plot.caption = element_text(size=10, color = "#d6d6d6", face = "italic", hjust = 0.5, margin = margin(t = 60)),
  plot.caption.position = "plot",
  plot.margin = unit(c(1, 0.5, 1, 0.5),"in"))

add_caption = labs(caption = "roanbuma.nl/wrap")
```
...
streaming_history_json <- fromJSON("my_spotify_data/Spotify Account Data/StreamingHistory_music_0.json")
...
ggsave("top_artists_wordcloud.png",
       width = 2160,
       height = 3840,
       units = "px")
```
...
ggsave("top_songs_wordcloud.png",
       width = 2160,
       height = 3840,
       units = "px")
```
...
ggsave("top_artist_top_songs_wordcloud.png",
       width = 2160,
       height = 3840,
       units = "px")
```
